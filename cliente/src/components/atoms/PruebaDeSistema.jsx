/**
 * The `PruebaDeSistema` function is a React component that renders a form for users to enter their
 * email and request a demo of a system.
 */
...
function PruebaDeSistema() {
   /**
    * The handleClick function displays a popup message and scrolls to a specific element on the page
    * when triggered.
    */
    const handleClick = () => {
        Swal.fire({
