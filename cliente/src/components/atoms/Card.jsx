...
import ImgAtesa from "../../assets/img/atesa.jpeg";
                    ...
                    <div class="our_solution_category">
                      <div class="solution_cards_box">
                        <div class="solution_card">
                          ...
                          <img src={ImgMatrix} width={40} viewBox="0 0 512 512" height="50" id="Layer_1"/>
                              <g>
                                <g>
                                  <g>
                                    <g>
                          ...
                          <div class="solu_title">
                            <div><b>Matrix</b> Pasión por tu Auto</div>
                          </div>
                          <div class="solu_description">
                            ...
                            <center>
                              <button class="read_more_btn" type="button">
                                <a href="https://www.facebook.com/matrixrinesyllantas" target="_blank">
                  ...
                  <div class="our_solution_category">
                      <div class="solution_cards_box">
                        <div class="solution_card">
                          <div class="hover_color_bubble"></div>
                          <div class="so_top_icon">
                          <img src={ImgMultillantas} width={40} viewBox="0 0 512 512" height="50" id="Layer_1"/>
                              <g>
                                <g>
                                  <g>
                                    <g>
                          ...
                          <div class="solu_title">
                            <div><b>Multillantas de Chiapas</b></div>
                          </div>
                          <div class="solu_description">
                            <p>
                            ...
                            <center>
                              <button class="read_more_btn" type="button">
                                <a href="https://www.facebook.com/profile.php?id=100073402030459" target="_blank">
                                  <img src={IconoFacebook}/>
                                </a>
                              </button>
                              <button class="read_more_btn" type="button">
                  ...
                  <div class="our_solution_category">
                      <div class="solution_cards_box">
                        <div class="solution_card">
                          <div class="hover_color_bubble"></div>
                          <div class="so_top_icon">
                          <img src={ImgGRUPCH} width={40} viewBox="0 0 512 512" height="50" id="Layer_1"/>
                              <g>
                                <g>
                                  <g>
                                    <g>
                          ...
                          <div class="solu_description">
                            ...
                            <div class="solu_description">
                              <p>
                              Un software con muchas bondades, intuitivos, no falla, no pierde datos, es transaccional y manejar millones de registros en sus bases de datos. Nuestro día a día en nuestra operación es constante libre de contratiempos gracias a este ERP estamos super contentos y llevamos desde el 2012 operando el sistema.
                              </p>
                            </div>
                            <center>
                              <button class="read_more_btn" type="button">
                  ...
                  <div class="our_solution_category">
                      <div class="solution_cards_box">
                        <div class="solution_card">
                          <div class="hover_color_bubble"></div>
                          <div class="so_top_icon">
                          <img src={ImgMahindra} width={40} viewBox="0 0 512 512" height="50" id="Layer_1"/>
                              <g>
                                <g>
                                  <g>
                                    <g>
                          ...
                          <div class="solu_title">
                            <div><b>CJC SERVICIOS DISTRIBUIDOR TRACTORES MAHINDRA</b></div>
                          </div>
                          <div class="solu_description">
                            <p>
                            Empresa especializada en el sector agrícola venta de tractores, implementos todo para el campo, refacciones de los mismos + servicio, contamos con la distribución de MAHINDRA.
                            </p>
                            <div class="solu_title">
                              <div><b>Sentir del cliente</b></div>
                            </div>
                            <div class="solu_description">
                              <p>
                              Prediction SOFTware MR es un software escalable con un ERP desde 2013, experimentando cambios continuos pero sin parches, garantizando funcionalidad al 100%. Destaca por su agilidad, velocidad y un servicio de consultoría excepcional proporcionado por KranzWide Consultive SA de CV. El sistema ofrece respaldo automático sin intervención del usuario, brindando tranquilidad al saber que la información se respalda en paralelo en otro lugar del mundo. La conectividad desde diversos dispositivos es ininterrumpida, gracias a la estabilidad de la nube.
                              </p>
                            </div>
                            <center>
                              <button class="read_more_btn" type="button">
                                <a href="https://www.facebook.com/cjcagropartes" target="_blank">
                                  <img src={IconoFacebook}/>
                                </a>
                              </button>
                              <button class="read_more_btn" type="button">
